package com.visionaidplusplus.mnnllm.android.utils
...
class MmapUtilsTest {
    ...
    fun setUp() {
        ...
        mockkStatic(com.visionaidplusplus.mls.api.ApplicationProvider::class)
        every { com.visionaidplusplus.mls.api.ApplicationProvider.get() } returns application
    }
