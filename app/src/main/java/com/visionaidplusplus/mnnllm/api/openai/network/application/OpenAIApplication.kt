package com.visionaidplusplus.mnnllm.api.openai.network.application
...
import com.visionaidplusplus.mnnllm.api.openai.manager.ServerEventManager
import com.visionaidplusplus.mnnllm.api.openai.manager.ServerEventMonitor
import com.visionaidplusplus.mnnllm.api.openai.network.logging.LogCollector
...
private fun Application.module(context: Context, host: String, port: Int) {
    ...
    //from com/visionaidplusplus/mnnllm/api/openai/network/application/HTTP.kt
    configureHTTP(context)

    //from com/visionaidplusplus/mnnllm/api/openai/network/application/Routing.kt
    configureRouting()
}
