...
import com.visionaidplusplus.mnnllm.api.openai.network.routes.chatRoutes
import com.visionaidplusplus.mnnllm.api.openai.network.routes.queueRoutes
import com.visionaidplusplus.mnnllm.api.openai.network.routes.modelsRoutes
import io.ktor.http.*
...
private fun loadHtmlFromAssets(): String {
    return try {
        ...
        val context = com.visionaidplusplus.mnnllm.android.MnnLlmApplication.getAppContext()
