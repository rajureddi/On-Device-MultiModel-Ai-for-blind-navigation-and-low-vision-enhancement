...
import com.visionaidplusplus.mnnllm.api.openai.service.OpenAIService
...
class ApiServiceActionReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_STOP_SERVICE = "com.visionaidplusplus.mnnllm.api.openai.STOP_SERVICE"
        const val ACTION_COPY_URL = "com.visionaidplusplus.mnnllm.api.openai.COPY_URL"
        const val ACTION_TEST_PAGE = "com.visionaidplusplus.mnnllm.api.openai.TEST_PAGE"
    ...
    private fun copyUrlToClipboard(context: Context, url: String) {
        ...
        try {
            ...
            val successMessage = context.getString(com.visionaidplusplus.mnnllm.android.R.string.api_url_copied)
