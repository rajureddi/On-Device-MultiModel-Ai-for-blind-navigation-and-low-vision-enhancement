package com.visionaidplusplus.mnnllm.api.openai.service

import android.content.Context
import com.visionaidplusplus.mnnllm.api.openai.di.ServiceLocator
import com.visionaidplusplus.mnnllm.api.openai.manager.ApiNotificationManager
import com.visionaidplusplus.mnnllm.api.openai.network.application.OpenAIApplication
...
class ApiServiceCoordinator(private val context: Context) {
    ...
    fun startServer(): Boolean {
        ...
        return runCatching {
            ...
            val serverEventManager = com.visionaidplusplus.mnnllm.api.openai.manager.ServerEventManager.getInstance()
            if (serverEventManager.getCurrentState() == com.visionaidplusplus.mnnllm.api.openai.manager.ServerEventManager.ServerState.STOPPED) {
    ...
    fun stopServer() {
        runCatching {
            ...
            com.visionaidplusplus.mnnllm.api.openai.manager.ServerEventManager.getInstance().resetRuntimeState()
