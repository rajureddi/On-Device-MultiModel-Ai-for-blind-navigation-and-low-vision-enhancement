...
import com.visionaidplusplus.mnnllm.android.utils.UiUtils.getThemeColor
...
class VoiceRecordingModule(private val activity: ChatActivity) {
    ...
    fun updateModel(modelName: String) {
        ...
        val isAudioModel = com.visionaidplusplus.mnnllm.android.model.ModelTypeUtils.isAudioModel(activity.modelId!!)
        updateVoiceButtonVisibility(isAudioModel)
