...
class ChatPresenter(
     ...
     */
    fun getLlmSession(): com.visionaidplusplus.mnnllm.android.llm.LlmSession? {
        return if (::chatSession.isInitialized && chatSession is com.visionaidplusplus.mnnllm.android.llm.LlmSession) {
            chatSession as com.visionaidplusplus.mnnllm.android.llm.LlmSession
        } else {
            null
        }
    }
    ...
    private fun applyChatHistoryToNewSession(newSession: ChatSession, currentChatHistory: List<ChatDataItem>) {
        if (newSession is com.visionaidplusplus.mnnllm.android.llm.LlmSession && currentChatHistory.isNotEmpty()) {
