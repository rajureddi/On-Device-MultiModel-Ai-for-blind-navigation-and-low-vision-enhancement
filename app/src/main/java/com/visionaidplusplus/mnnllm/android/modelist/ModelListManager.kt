...
import com.visionaidplusplus.mls.api.download.DownloadPersistentData
...
import com.visionaidplusplus.mnnllm.android.modelmarket.ModelMarketItem
import com.visionaidplusplus.mnnllm.android.modelmarket.ModelMarketCache
...
object ModelListManager {
    ...
    private suspend fun processModelWrapper(
        ...
        try {
            ...
            val marketItem = modelItem.modelMarketItem as? com.visionaidplusplus.mnnllm.android.modelmarket.ModelMarketItem
            if (marketItem != null) {
...
//            localModel.loadMarketTags(context)
            ...
            val marketItemForTags = localModel.modelMarketItem as? com.visionaidplusplus.mnnllm.android.modelmarket.ModelMarketItem
            ...
            if (localModel.modelName.isNullOrEmpty()) {
                val marketItem = localModel.modelMarketItem as? com.visionaidplusplus.mnnllm.android.modelmarket.ModelMarketItem
