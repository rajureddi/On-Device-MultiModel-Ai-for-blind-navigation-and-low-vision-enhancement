...
import com.visionaidplusplus.mnnllm.android.asr.AsrService
import com.visionaidplusplus.mnnllm.android.audio.AudioChunksPlayer
import com.visionaidplusplus.mnnllm.android.chat.ChatPresenter
import com.visionaidplusplus.mnnllm.android.chat.GenerateResultProcessor
import com.visionaidplusplus.mnnllm.android.utils.VoiceModelPathUtils
...
class VoiceChatPresenter(
    ...
    private fun speakGreetingMessage() {
        lifecycleScope.launch {
            try {
                ...
                val greetingMessage = activity.getString(com.visionaidplusplus.mnnllm.android.R.string.voice_chat_ready_greeting)
    ...
    fun stop() {
        ...
        if (isProcessingLlm || isSpeaking) {
            ...
            if (activity is com.visionaidplusplus.mnnllm.android.chat.ChatActivity) {
