...
package com.visionaidplusplus.mnnllm.android.chat.chatlist
...
import com.visionaidplusplus.mnnllm.android.chat.ChatActivity
import com.visionaidplusplus.mnnllm.android.chat.PromptUtils
import com.visionaidplusplus.mnnllm.android.chat.model.ChatDataItem
import com.visionaidplusplus.mnnllm.android.chat.SelectTextActivity
import com.visionaidplusplus.mnnllm.android.utils.ClipboardUtils
import com.visionaidplusplus.mnnllm.android.utils.DeviceUtils
...
import com.visionaidplusplus.mnnllm.android.utils.UiUtils
import com.visionaidplusplus.mnnllm.android.widgets.FullScreenImageViewer
import com.visionaidplusplus.mnnllm.android.widgets.PopupWindowHelper
...
object ChatViewHolders {
    ...
    class UserViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView), View.OnClickListener,
        ...
        val chatVideo: com.visionaidplusplus.mnnllm.android.widgets.VideoPreviewView =
    ...
    class AssistantViewHolder @SuppressLint("ClickableViewAccessibility") constructor(view: View) :
        ...
        init {
            ...
            toggleBenchmarkButton.setOnClickListener {
                val chatActivity = itemView.context as? com.visionaidplusplus.mnnllm.android.chat.ChatActivity
        ...
        private fun replayAudio(chatDataItem: ChatDataItem) {
            if (chatDataItem.hasOmniAudio && !chatDataItem.audioPath.isNullOrEmpty()) {
                ...
                val audioPlayService = com.visionaidplusplus.mnnllm.android.utils.AudioPlayService.instance
                audioPlayService?.playAudio(chatDataItem.audioPath, object : com.visionaidplusplus.mnnllm.android.utils.AudioPlayService.AudioPlayerCallback {
