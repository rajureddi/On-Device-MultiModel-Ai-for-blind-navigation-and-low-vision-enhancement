...
import com.visionaidplusplus.mls.api.download.DownloadListener
...
import com.visionaidplusplus.mnnllm.android.modelmarket.ModelRepository
...
class VoiceModelMarketViewModel(application: Application) : AndroidViewModel(application), DownloadListener {
    ...
    fun setDefaultTtsModel(modelId: String) {
        ...
        com.visionaidplusplus.mnnllm.android.mainsettings.MainSettings.setDefaultTtsModel(context, modelId)
        Log.d(TAG, "Set default TTS model: $modelId")
    }

    fun setDefaultAsrModel(modelId: String) {
        val context = getApplication<Application>()
        com.visionaidplusplus.mnnllm.android.mainsettings.MainSettings.setDefaultAsrModel(context, modelId)
