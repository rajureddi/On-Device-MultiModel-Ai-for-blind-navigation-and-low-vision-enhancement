...
object ModelRepository {
    ...
    private val context: Context by lazy { 
        com.visionaidplusplus.mnnllm.android.MnnLlmApplication.getAppContext()
    }
    ...
    private fun isAllowNetwork(context: Context): Boolean {
        return com.visionaidplusplus.mnnllm.android.utils.PreferenceUtils.getBoolean(context, KEY_ALLOW_NETWORK_MARKET_DATA, false)
    }
    
    private fun isNetworkDelayEnabled(context: Context): Boolean {
        return com.visionaidplusplus.mnnllm.android.utils.PreferenceUtils.getBoolean(context, "debug_enable_network_delay", false)
    }
