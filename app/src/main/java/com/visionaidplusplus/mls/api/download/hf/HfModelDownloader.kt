...
package com.visionaidplusplus.mls.api.download.hf

import android.util.Log
import com.visionaidplusplus.mls.api.ApplicationProvider
import com.visionaidplusplus.mls.api.FileDownloadException
import com.visionaidplusplus.mls.api.download.DownloadExecutor.Companion.executor
import com.visionaidplusplus.mls.api.download.DownloadFileUtils.createSymlink
import com.visionaidplusplus.mls.api.download.DownloadFileUtils.deleteDirectoryRecursively
import com.visionaidplusplus.mls.api.download.DownloadFileUtils.getLastFileName
import com.visionaidplusplus.mls.api.download.DownloadFileUtils.getPointerPathParent
import com.visionaidplusplus.mls.api.download.DownloadFileUtils.repoFolderName
import com.visionaidplusplus.mls.api.download.DownloadPausedException
import com.visionaidplusplus.mls.api.download.FileDownloadTask

import com.visionaidplusplus.mls.api.download.ModelFileDownloader
import com.visionaidplusplus.mls.api.download.ModelFileDownloader.FileDownloadListener
import com.visionaidplusplus.mls.api.download.ModelRepoDownloader
import com.visionaidplusplus.mls.api.download.hf.HfFileMetadataUtils.getFileMetadata
import com.visionaidplusplus.mls.api.HfApiClient
import com.visionaidplusplus.mls.api.HfApiClient.Companion.bestClient
import com.visionaidplusplus.mls.api.HfFileMetadata
import com.visionaidplusplus.mls.api.HfRepoInfo
import com.visionaidplusplus.mls.api.download.DownloadCoroutineManager
    ...
    private suspend fun fetchRepoInfo(modelId: String, calculateSize: Boolean = false): HfRepoInfo {
        return withContext(DownloadCoroutineManager.downloadDispatcher) {
            runCatching {
                ...
                val response = getHfApiClient().getRepoInfo(hfModelId, "main").execute()
    ...
    override suspend fun getRepoSize(modelId: String): Long {
        return withContext(DownloadCoroutineManager.downloadDispatcher) {
            runCatching {
                ...
                try {
                    val marketSize = com.visionaidplusplus.mls.api.download.DownloadPersistentData.getMarketSizeTotal(ApplicationProvider.get(), modelId)
                    if (marketSize > 0) {
